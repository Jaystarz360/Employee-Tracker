...
## Description
Employee tracker that you can add, deleted and change informaiton with in datebase.

## Usage
After installation of PackageJSON and sourcing the database and seed, begin the application with "node server.js"
